    ...
    <section className="bg-[url('./img/bg-img2.jpg')] bg-cover">
      ...
      <div className="flex h-screen items-center justify-center px-3 md:items-start md:pt-26 lg:mr-23 lg:items-center lg:justify-end lg:pt-0">
        <form class="font-montserrat blue w-md rounded-2xl bg-white/30 px-10 py-8 shadow backdrop-blur-lg">
          ...
          <div class="group justify-beetween relative z-0 flex w-full items-center border-0 border-b-2 border-gray-600">
            <input
              type="email"
              name="floating_email"
              id="floating_email"
          ...
          <div class="group justify-beetween relative z-0 mt-7 flex w-full items-center border-0 border-b-2 border-gray-600">
            <input
              type="password"
